...
class RootViewModel {
  ...
  userLogin: ko.Observable<string>| ko.Observable<any>;
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "incidents", detail: { label: "Account", iconClass: "oj-ux-ico-fire" } },
      { path: "customers", detail: { label: "Registration", iconClass: "oj-ux-ico-contact-group" } },
